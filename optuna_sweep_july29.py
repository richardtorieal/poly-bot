...
def main():
    logger.info("Initializing In-Sample custom Optuna sweep for July 29...")
    study_name = "btc_trend_opt_july29_is"
    storage_url = "sqlite:///optuna_study_july29.db"
    
    if os.path.exists("optuna_study_july29.db"):
        try:
            os.remove("optuna_study_july29.db")
