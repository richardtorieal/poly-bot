...
def main():
    logger.info("Initializing In-Sample Optuna sweep for August 5...")
    study_name = "btc_trend_opt_aug5"
    storage_url = "sqlite:///optuna_study_aug5.db"
    
    if os.path.exists("optuna_study_aug5.db"):
        try:
            os.remove("optuna_study_aug5.db")
    ...
    baseline_params = {
        'lookback_minutes': 2,
        'er_lookback': 2,
        'btc_threshold': 0.00018817760831303125,
        'btc_threshold_up': 0.00018703670194672277,
        'btc_threshold_down': 0.00018670591544290915,
        'er_threshold': 0.664071817303994,
        'exit_profit_pct': 0.010045369956025119,
        'stop_loss_pct': 0.017918255585849842,
        'max_minutes_elapsed': 10.199452699597028,
    ...
    num_workers = 6
    trials_per_worker = 80 # 480 trials total
