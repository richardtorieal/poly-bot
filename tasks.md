...
- [x] Implement `optimize` CLI command for live margin tuning @test-engineer (Last run: 2026-06-28, Optimal OOS Sharpe: 179.13, MaxDD: -1.95% with BTCTrendStrategy btc_threshold: 0.00015, btc_threshold_up: 0.00017, btc_threshold_down: 0.00008, lookback_minutes: 2, er_threshold: 0.5, pos_size_pct: 0.03, exit_profit_pct: 0.0052, stop_loss_pct: 0.015, max_minutes_elapsed: 8.0, filter_strike_trend: true) # Optimization successfully completed on 2026-06-28
