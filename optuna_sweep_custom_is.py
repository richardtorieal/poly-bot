...
def main():
    logger.info("Initializing In-Sample custom Optuna sweep...")
    study_name = "btc_trend_opt_custom_is"
    storage_url = "sqlite:///optuna_study_custom_is.db"
    
    if os.path.exists("optuna_study_custom_is.db"):
        try:
            os.remove("optuna_study_custom_is.db")
